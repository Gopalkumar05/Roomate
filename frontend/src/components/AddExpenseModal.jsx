  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        await axios.put(`https://roomate-r5s9.onrender.com/api/expenses/${expense._id}`, expenseData, {
          headers: { Authorization: `Bearer ${token}` }
        });
      } else {
        // Create new expense
        await axios.post('https://roomate-r5s9.onrender.com/api/expenses', expenseData, {
          headers: { Authorization: `Bearer ${token}` }
        });
      }
